...
class ProductControllerApi extends Controller
{
    ...
    public function get_product_chart(){
        ...
        return response()->json(array('ok' => true,'product_names' => $product_names, 'product_prices' => $product_prices));
    }
    public function get_category_chart(){
        ...
        return response()->json(array('ok' => true,'cat_names'=>$cat_names,'cat_prices' => $cat_prices));
    }
}
