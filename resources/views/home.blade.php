...
@section('title') BikeShop | อุปกรณ์จักรยาน , อะไหล่ , ชุดแข่งและอุปกรณ์@stop

@section('content')

<div class="container" ng-app="app" ng-controller="ctrl">
    <h1>@{ helloMessage }</h1>
    {{-- <input type="text" class="form-control" ng-model="query" placeholder="ค้นหา">
    ...
    <h3 ng-if="!products.length">ไม่พบสินค้า</h3> --}}
    <div class="row">
        <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="#" class="list-group-item" ng-class="{'active' : category == c.id}" ng-click="getProductList(c)" ng-repeat="c in categories">@{c.name}</a>
            </div>
        </div>
        <div class=col-md-9>
            <div class="row">
                    ...
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="#" class="btn btn-success btn-block" ng-click="addToCart(p)">
                                <i class="fa fa-shopping-cart"></i> หยิบใส่ตระกล้า
                            </a>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    app.controller('ctrl' , function($scope , productService){
        $scope.helloMessage = "ยินดีต้อนรับสู้ AngularJS";
